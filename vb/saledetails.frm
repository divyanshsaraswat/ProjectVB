...
Begin VB.Form saledetails 
   ...
   Begin VB.ListBox List2 
      Height          =   510
      ItemData        =   "saledetails.frx":0004
      Left            =   4560
      List            =   "saledetails.frx":0006
      Style           =   1  'Checkbox
      TabIndex        =   9
      Top             =   840
      Width           =   4335
   ...
   Begin VB.ComboBox Category 
      Height          =   315
      ItemData        =   "saledetails.frx":0008
      Left            =   2760
      List            =   "saledetails.frx":002D
      TabIndex        =   2
      Top             =   240
      Width           =   615
   End
   Begin VB.ComboBox sowner 
      Height          =   315
      ItemData        =   "saledetails.frx":0057
      Left            =   1080
      List            =   "saledetails.frx":0067
      TabIndex        =   1
      Top             =   240
      Width           =   615
   End
