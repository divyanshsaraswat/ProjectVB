...
Begin VB.Form qutdetails 
   ...
   Begin VB.ComboBox sowner 
      Height          =   315
      ItemData        =   "qutdetails.frx":0000
      Left            =   1080
      List            =   "qutdetails.frx":0010
      TabIndex        =   9
      Top             =   240
      Width           =   615
   End
   Begin VB.ComboBox Category 
      Height          =   315
      ItemData        =   "qutdetails.frx":0024
      Left            =   2760
      List            =   "qutdetails.frx":0049
      TabIndex        =   8
      Top             =   240
      Width           =   615
   End
   ...
   Begin VB.ListBox List2 
      Height          =   510
      ItemData        =   "qutdetails.frx":0073
      Left            =   4560
      List            =   "qutdetails.frx":0075
      Style           =   1  'Checkbox
      TabIndex        =   4
      Top             =   840
      Width           =   4335
   ...
   Begin VB.ListBox List1 
      Height          =   510
      ItemData        =   "qutdetails.frx":0077
      Left            =   1080
      List            =   "qutdetails.frx":0079
      Style           =   1  'Checkbox
      TabIndex        =   0
      Top             =   840
      Width           =   1575
...
'Set objBook = objExcel.Workbooks.Open("c:\\daksh\vb\Qut Details.xls")
...
''objsheet.Cells.Range([i ,1], [i ,20]).Select
''MsgBox (objsheet.Cells.Range([i ,1], [i ,20]).Select)
...
objBook.SaveAs "Quotation.xls"
objExcel.Workbooks.Open "Quotation.xls"
...
str1 = "Select distinct(chissue) from tblqut order by chissue"
...
str1 = "Select distinct(nappno) from tblqut order by nappno"
res1.Open str1, MDIForm1.con1, adOpenDynamic, adLockOptimistic
...
str1 = "Select distinct(chthrough) from tblqut order by chthrough"
res1.Open str1, MDIForm1.con1, adOpenDynamic, adLockOptimistic
through.Clear
While (res1.EOF = False)
...
Load estinv
estinv.qut.Text = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.row, 2)
estinv.load_Click
estinv.Show
End Sub
...
If (listapp <> "") Then
    ...
    If (str2 <> Empty) Then
     str2 = str2 & " And tblqut.nappno in(" & listapp & ")"
     Else
     str2 = str2 & " tblqut.nappno in(" & listapp & ")"
    End If
End If
...
If (Category.Text <> Empty) Then
    If (str2 <> Empty) Then
    str2 = str2 & " And tblqut.chcategory=" & "'" & Category.Text & "'"
    Else
    str2 = str2 & " tblqut.chcategory=" & "'" & Category.Text & "'"
    End If
End If

If (sowner.Text <> Empty) Then
    If (str2 <> Empty) Then
    str2 = str2 & " And tblqut.chowner=" & "'" & MDIForm1.parserText(sowner.Text) & "'"
    Else
    str2 = str2 & " tblqut.chowner=" & "'" & MDIForm1.parserText(sowner.Text) & "'"
    End If
End If
...
If (through.Text <> Empty) Then
    If (str2 <> Empty) Then
    str2 = str2 & " And tblqut.chthrough=" & "'" & MDIForm1.parserText(through.Text) & "'"
    Else
    str2 = str2 & " tblqut.chthrough=" & "'" & MDIForm1.parserText(through.Text) & "'"
    End If
End If

 If (sdate.Text <> Empty) Then
    If (str2 <> Empty) Then
    str2 = str2 & " And tblqut.ddate>= #" & Format(sdate.Text, "dd-mmm-yy") & "# "
    Else
    str2 = str2 & " tblqut.ddate >= #" & Format(sdate.Text, "dd-mmm-yy") & "# "
    End If
  End If

    If (EDate.Text <> Empty) Then
        If (str2 <> Empty) Then
            str2 = str2 & " And tblqut.ddate<=#" & Format(EDate.Text, "dd-mmm-yy") & "# "
        Else
            str2 = str2 & " tblqut.ddate<=#" & Format(EDate.Text, "dd-mmm-yy") & "# "
        End If
    End If

If (str2 <> Empty) Then
str1 = str1 & " where " & str2 & " order by tblqut.nappno,tblqut.chcategory,tblqut.ncode"
Else
str1 = str1 & " order by tblqut.nappno,tblqut.chcategory,tblqut.ncode"
End If
...
While (res.EOF = False)
    ...
    If (IsNull(res!nrate1) = False) Then
      MSHFlexGrid1.TextMatrix(i, 6) = res!nrate1
    End If
    If (IsNull(res!nrate2) = False) Then
    MSHFlexGrid1.TextMatrix(i, 9) = res!nrate2
    End If
    If (IsNull(res!nrate3) = False) Then
    MSHFlexGrid1.TextMatrix(i, 12) = res!nrate3
    End If
    If (IsNull(res!nrate4) = False) Then
    MSHFlexGrid1.TextMatrix(i, 14) = res!nrate4
    End If
