...
Begin VB.Form spdetails 
   Caption         =   "Sales/Purchase Details"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   LinkTopic       =   "Sales/Purchase Details"
   ScaleHeight     =   8340
   ScaleWidth      =   15240
   ...
   Begin VB.ComboBox sowner 
      Height          =   315
      ItemData        =   "spdetails.frx":0000
      Left            =   1080
      List            =   "spdetails.frx":0010
      TabIndex        =   9
      Top             =   240
      Width           =   615
   End
   Begin VB.ComboBox Category 
      Height          =   315
      ItemData        =   "spdetails.frx":0024
      Left            =   2760
      List            =   "spdetails.frx":0049
      TabIndex        =   8
      Top             =   240
      Width           =   615
   End
   ...
   Begin VB.ListBox List2 
      Height          =   510
      ItemData        =   "spdetails.frx":0073
      Left            =   4560
      List            =   "spdetails.frx":0075
      Style           =   1  'Checkbox
      TabIndex        =   4
      Top             =   840
      Width           =   4335
   ...
   Begin VB.ListBox List1 
      Height          =   510
      ItemData        =   "spdetails.frx":0077
      Left            =   1080
      List            =   "spdetails.frx":0079
      Style           =   1  'Checkbox
      TabIndex        =   0
      Top             =   840
      Width           =   1575
